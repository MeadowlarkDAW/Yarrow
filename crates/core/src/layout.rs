use crate::math::{Margin, Point, Rect, Size};
...
#[derive(Debug, Clone, Copy, PartialEq)]
pub struct LayoutMarginMarginResult {
...
/// padding applied.
pub fn layout_padded_rect(padding: Margin, content_rect: Rect) -> Rect {
    Rect {
        origin: Point::new(
...
/// will return `None`.
pub fn layout_inner_rect(padding: Margin, outer_rect: Rect) -> Option<Rect> {
...
#[derive(Debug, Clone, Copy, PartialEq)]
pub struct LayoutMarginMarginBoundedResult {
...
pub fn layout_margin_padding_bounded(
    ...
    stretch: Stretch,
) -> LayoutMarginMarginBoundedResult {
    struct HResult {
        bounds_x: f32,
        bounds_width: f32,
        content_width: f32,
...
mod tests {
    ...
    fn test_layout_margin_padding() {
        ...
        let padding = Margin::new(5.0, 6.0, 7.0, 8.0);
